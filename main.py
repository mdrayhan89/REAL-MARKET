...
# --- GLOBAL STATE ---
bot_running = False  # শুরুতে অফ থাকবে
signals_history = []
...
def get_signal_logic():
    # অনেকগুলো পেয়ার চেক করে সেরাটি বেছে নেওয়া
    for pair in PAIRS:
        try:
...
def signal_loop():
    ...
    while True:
        # স্ট্রিক্ট চেক: বট অফ থাকলে কিছুই করবে না
        if bot_running:
            now = datetime.datetime.now(TZ)
            current_min_id = now.strftime("%H:%M")
            
            # ৪৮তম সেকেন্ডে চেক এবং ডাবল মেসেজ প্রোটেকশন
